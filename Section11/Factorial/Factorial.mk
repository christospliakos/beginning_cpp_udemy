...
ProjectPath            :=C:/Users/Work/Desktop/beginning_cpp_udemy/Section11/Factorial
...
Objects0=../build-$(ConfigurationName)/Factorial/main.cpp$(ObjectSuffix) 
...
../build-$(ConfigurationName)/Factorial/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/Factorial/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Work/Desktop/beginning_cpp_udemy/Section11/Factorial/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
