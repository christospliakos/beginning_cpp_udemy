...
ProjectPath            :=C:/Users/Work/Desktop/beginning_cpp_udemy/Section11/Fibonacci
...
Objects0=../build-$(ConfigurationName)/Fibonacci/main.cpp$(ObjectSuffix) 
...
$(OutputFile): ../build-$(ConfigurationName)/Fibonacci/.d $(Objects) 
	@if not exist "..\build-$(ConfigurationName)\Fibonacci" mkdir "..\build-$(ConfigurationName)\Fibonacci"
...
../build-$(ConfigurationName)/Fibonacci/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/Fibonacci/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Work/Desktop/beginning_cpp_udemy/Section11/Fibonacci/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
