...
//    
    ...
    // Determine if an entered integer is exactly on 2 other integers
    // assume lower < upper
//    cout << "\n Enter and integer - the bounds are " << lower << " and " << upper << ": ";
//    cin >> num;
//    
...
//    
    ...
    // Determing if you need to wear a coat based on temperature and wind speed
    bool wear_coat {false};
    double temperature {};
    int wind_speed {};
    
    const int wind_speed_for_coat {25};     //Wind over this value requires a coat
    const double temperature_for_coat {45}; // Bellow that -> coat.
    
    cout << "\nEnter the current temperature in (F): ";
    cin >> temperature;
    cout << "\nEnter the windspeed in mph: ";
    cin >> wind_speed;
